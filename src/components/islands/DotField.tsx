// DotField background — from ReactBits (https://reactbits.dev/backgrounds/dot-field,
// MIT). Self-contained canvas: a gradient-filled dot field that bulges away from
// the cursor with a soft glow. Colors are themeable via gradientFrom/To/glowColor.
...
const DotField = memo(({
  ...
  // Deterministic id (stable across SSR + hydration; Math.random() would mismatch).
