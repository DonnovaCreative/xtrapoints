// @ts-nocheck
// Vendored from React Bits (https://reactbits.dev/backgrounds/side-rays, JS/CSS) —
// animated light rays from a corner (WebGL via ogl). Rendered as a client:only
// island in the school heroes (WebGL can't be server-rendered by the on-demand
// preview functions — see DECISIONS.md). Layered UNDER DotField. The container
// styles from the source CSS are inlined here (no separate .css file).
